                        ...
                        <div class="dash">
                            <!-- <ul class="list-group list-group-flush"> -->
                                <div class="card-header" style="background-color: #fff; color: #465377; font-weight: 600;">
                                   <span class="mr-5"> Recent Lab Results </span> <a href="results.php" class="card-text small ml-5" style="color: #344676; text-decoration: none;">View all<span class="new fa fa-arrow-right ml-2"></span></a>
                                </div>
                                <table class="table">
                                    <tbody>
                                        <tr>
                        ...
                        <div class="dash">
                            <!-- <ul class="list-group list-group-flush"> -->
                                <div class="card-header" style="background-color: #fff; color: #344676; font-weight: 600;">
                                    Upcoming Appointments <a href="appointments.php" class="card-text small ml-5" style="color: #344676; text-decoration: none;">View all<span class="new fa fa-arrow-right ml-2"></span></a>
                                </div>
                                <table class="table">
                                    <tbody>
                                        <tr>
