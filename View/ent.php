                ...
                <div class="container h-100">
                    <div class="row h-100">
                        <div class="col-lg-6 my-auto ">
                            <div class="mx-auto">
                                <h5 class="mb-4">EAR NOSE AND THROAT</h5>
                            ...
                            <div class="mx-auto">
                                <div class="card side serv shadow p-3 mb-5 bg-white rounded" style="width: 18rem;">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item my-2 py-2"> <a class=" hov" href="lab.html"> <i class="fa fa-vial fa-1x mr-4 text-center"></i>Laboratory</a></li>
