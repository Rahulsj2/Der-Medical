                            ...
                            <div class="mx-auto">
                                <div class="card side serv shadow p-3 mb-5 bg-white rounded" style="width: 18rem;">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item my-2 py-2"> <a class=" hov" href="cardio.php"> <i class="fa fa-heartbeat fa-1x mr-4 text-center"></i>Cardiology </a></li>
                                        ...
                                        <li class="list-group-item my-2 py-2"> <a class=" hov" href="neuro.php"> <i class="fa fa-brain fa-1x mr-4 text-center"></i>Neurosurgery</a></li>
